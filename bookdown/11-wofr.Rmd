...
We were able to create a SDM using the vegetation land cover information with moderate fit (AUC = 0.74). The vegetation based model indicated that this species is predicted to have high abundance in native wetland (bogs, fens, swamps) and treed bog habitats in addition to high abundance in crops, rough pasture, tame pasture, cut-blocks, and urban industrial footprints. 
...
<center>
![The spatial and climate components from the vegetation based model for Wood Frog.](Amphibians_files/figure-html/coefficients/north/WOFR_climate_2022-01-20.png){width=60%}

</center>

## Soil Models

We were able to create a SDM using the soil land cover information with moderate fit (AUC = 0.82). The soil based models predicted higher abundance in loamy, sandy/loamy, and clay soil classes and high abundance in all footprint types. There was a strong positive effect between treed and non-treed sites.
...
<center>
![The spatial and climate components from the soil based model for Wood Frog.](Amphibians_files/figure-html/coefficients/south/WOFR_climate_2022-01-20.png){width=60%}
...
The vegetation based models indicate that Wood Frog increased in all linear feature types. The soil based models also indicated the same pattern except for a slight increase in Energy Soft Linear features.
...
<center>
![The predicted relative abundance of Wood Frog as a function of vegetation, soil, human footprint, and space/cliamte across Alberta under reference conditions.](Amphibians_files/figure-html/maps/WOFR_reference-abundance_2022-02-08.png){width=45%} ![The predicted relative abundance of Wood Frog as a function of vegetation, soil, human footprint, and space/cliamte across Alberta under current conditions (2018).](Amphibians_files/figure-html/maps/WOFR_current-abundance_2022-02-08.png){width=45%}
...
<center>
![The change in predicted relative abundance of Wood Frog as a function of vegetation, soil, human footprint, and space/cliamte across Alberta between reference and current condition (2018 footprint).](Amphibians_files/figure-html/maps/WOFR_difference_2022-02-08.png){width=80%} 
...
We predicted that Wood Frog has local positive responses to all sectors within this region. However, the responses are strongest for agriculture and forestry. In addition, we observe a moderate regional effect of agriculture. 
