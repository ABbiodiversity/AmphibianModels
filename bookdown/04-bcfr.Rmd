...
<center>
![The spatial and climate components from the vegetation based model for Boreal Chorus Frog.](Amphibians_files/figure-html/coefficients/north/BCFR_climate_2022-01-20.png){width=60%}
...
<center>
![The spatial and climate components from the soil based model for Boreal Chorus Frog.](Amphibians_files/figure-html/coefficients/south/BCFR_climate_2022-01-20.png){width=60%}
...
<center>
![The predicted relative abundance of Boreal Chorus Frog as a function of vegetation, soil, human footprint, and space/cliamte across Alberta under reference conditions.](Amphibians_files/figure-html/maps/BCFR_reference-abundance_2022-02-08.png){width=45%} ![The predicted relative abundance of Boreal Chorus Frog as a function of vegetation, soil, human footprint, and space/cliamte across Alberta under current conditions (2018).](Amphibians_files/figure-html/maps/BCFR_current-abundance_2022-02-08.png){width=45%} 
...
<center>
![The change in predicted relative abundance of Boreal Chorus Frog as a function of vegetation, soil, human footprint, and space/cliamte across Alberta between reference and current condition (2018 footprint).](Amphibians_files/figure-html/maps/BCFR_difference_2022-02-08.png){width=80%} 
